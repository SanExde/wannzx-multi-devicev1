...
export async function participantsUpdate({ id, participants, action }) {
  ...
  conn.sendButtonDoc(id, wm, text, action == 'add' ? '⫷ ᴡᴇʟᴄᴏᴍᴇ ⫸' : '⫷ sᴀʏᴏɴᴀʀᴀ ⫸', action === 'add' ? '.intro' : '「 𝐖𝐚𝐧𝐧𝐳𝐱-𝐌𝐝 」', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: false,
...
/*  let welcom = 'https://telegra.ph/file/292d89177a642590faaf8.jpg'

  let godbye = 'https://telegra.ph/file/bb1e8fdf7c9763ad1d9f4.jpg'
  conn.sendButtonImg(id, await(await fetch(action === 'add' ? wel : lea)).buffer(), 'Group Messege', text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : '「 𝐖𝐚𝐧𝐧𝐳𝐱-𝐌𝐝 」', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: false,
...
const fgclink = {
  ...
  if (rown) return conn.sendButtonDocAccess(m.chat, `${ucapan()} ` + tag, rown + '\n\n\n\n', '⫷ ᴏᴡɴᴇʀ ⫸', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
...
mods: '*ᴏɴʟʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ* • ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ'}[type]
  if (mod) return conn.sendButtonDocAccess(m.chat, `${ucapan()} ` + tag, mod + '\n\n\n\n', '⫷ ᴍᴇɴᴜ ⫸', '.menu', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: 'https://instagram.com/wannzx_133',
    mediaType: 2, 
    description: sgc,
    title: "Join Sini Juga Cuy!",
...
let prm = {
  ...
  if (prm) return conn.sendButtonDocAccess(m.chat, `${ucapan()} ` + tag, prm + '\n\n\n\n', '⫷ ʙᴇʟɪ ᴘʀᴇᴍɪᴜᴍ ⫸', '.sewa', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: 'https://instagram.com/wannzx_133',
    mediaType: 2, 
    description: sgc,
    title: "Join Sini Juga Cuy!",
...
let msg = {
  ...
  /*  if (msg) return conn.sendButtonDoc(m.chat, msg, wm, '⫷ ᴍᴇɴᴜ ⫸', '.menu', fgclink)*/
...
if (msgg) return conn.sendButtonDocAccess(m.chat, `${ucapan()} ` + tag, msgg + '\n\n\n\n', '⫷ ᴠᴇʀɪғʏ ⫸', '.verify', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: 'https://instagram.com/wannzx_133',
    mediaType: 2, 
    description: sgc,
    title: "Join Sini Juga Cuy!",
