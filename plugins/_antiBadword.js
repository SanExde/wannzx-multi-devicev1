...
Anda hanya bisa meminta Owner untuk membuka banned-nya !\n\n𝐆𝐫𝐨𝐮𝐩 𝐖𝐚𝐧𝐧𝐁𝐨𝐭𝐳-𝐌𝐃 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥:
https://chat.whatsapp.com/Bbh5bDDQsWQBxQTaY5tHBJ

“Barang siapa yang beriman kepada Allah dan Hari Akhir maka hendaklah dia berkata baik atau diam” (HR. al-Bukhari dan Muslim).`, wm, [['⫷ ᴄᴇᴋ ᴅᴏsᴀ ⫸', '.cekdosa'], ['⫷ ᴏᴡɴᴇʀ ⫸', '.owner']], m)
        if (user.warning >= 5) {
            user.banned = true
            if (m.isGroup) {
                if (isBotAdmin) {
