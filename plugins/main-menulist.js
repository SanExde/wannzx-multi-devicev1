...
${emot} *Exp:* %exp / %maxexp
${emot} *Total Exp:* %totalexp

❍⃕  *T O D A Y*

${emot} *Days:* %week %weton
${emot} *Date:* %date
${emot} *Islamic 𝙳𝙰𝚃𝙴:* %dateIslamic
${emot} *Time:* %wib
...
${emot} *Prefix:* [ *%_p* ]
${emot} *Up Time:* %muptime
${emot} *Database:* %rtotalreg dari %totalreg
