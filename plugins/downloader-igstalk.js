...
if (command == 'igstalk') {
if (!text) throw `Contoh:\n${usedPrefix + command} wannzx_133`
let f = await axios(`https://api.xteam.xyz/dl/igstalk?nama=${text}&APIKEY=HIRO`)
let x = f.data
...
${cmenuf}
`
let buttons = [{ buttonText: { displayText: '⫷ ᴘʀᴏғɪʟᴇ ⫸' }, buttonId: `.profile` }, { buttonText: { displayText: '⫷ ᴅᴏɴᴀsɪ ⫸' }, buttonId: '.donasi' }, { buttonText: { displayText: '⫷ sᴇᴡᴀ ʙᴏᴛ ⫸' }, buttonId: '.sewa' }]
