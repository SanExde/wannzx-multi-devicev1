...
if(!args[0]) throw "Masukkan Nama Lokasi"
        ...
        conn.sendButton(m.chat, botdate, caption, await(await fetch(thumbnailUrl.getRandom())).buffer(), [['⫷ ᴍᴇɴᴜ ⫸', '/menu'],['⫷ ᴏᴡɴᴇʀ ⫸', '.owner'],['⫷ ʙᴏᴏsᴛ ⫸', '.boost']], m, { fileLength: fsizedoc, seconds: fsizedoc, contextInfo: {
        externalAdReply :{
    mediaUrl: sig,
    mediaType: 2,
    description: wm, 
