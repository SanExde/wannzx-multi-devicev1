...
let tiktok = `
    ${htka} Tiktok Downloader ${htki}

 Silakan pilih Tiktok Downloader di tombol di bawah...

*Link yang anda kirim:* ${args[0]}

Ketik ulang *${usedPrefix + command}* link anda untuk mengubah video yang diunduh
...
const sections = [
   {
	title: `${htka} Tiktok Downloader ${htki}`,
	rows: [
